...
public class GameOverState : AState, InputActions.IGameOverActions
{
    ...
    public void OnUp(InputAction.CallbackContext context) { 
        if(manager.ActionOf(context) && context.performed) { Move(MoveDirection.Up); }
    }
    public void OnDown(InputAction.CallbackContext context) { 
        if(manager.ActionOf(context) && context.performed) { Move(MoveDirection.Down); }
    }
    public void OnLeft(InputAction.CallbackContext context) { 
        if(manager.ActionOf(context) && context.performed) { Move(MoveDirection.Left); }
    }
    public void OnRight(InputAction.CallbackContext context) {
        if(manager.ActionOf(context) && context.performed) { Move(MoveDirection.Right); }
     }
